...
func main() {
	...
	fmt.Printf("Rata-rata kecepatan mobil %s (%d), \n", m1.merek, m1.tahun_produksi)
	fmt.Printf("mobil %s (%d), dan mobil %s (%d)\n", m2.merek, m2.tahun_produksi, m3.merek, m3.tahun_produksi)
	fmt.Printf("%.2f\n", rata_rata_kecepatan)
}
